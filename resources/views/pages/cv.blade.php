    ...
    <div class="max-w-5xl mx-auto space-y-12">
        ...
        <section aria-labelledby="profil-title">
            <div class="bg-white/60 backdrop-blur-md border border-pink-100 shadow-lg rounded-xl p-6 mt-12">
                <h2 id="profil-title" class="text-3xl font-extrabold text-gray-900 border-b-4 border-pink-300 pb-1 mb-6">
                    Profil
                </h2>
                ...
                <div class="md:flex md:items-start md:gap-6">
                    ...
                    <div class="md:w-3/4 text-gray-700 leading-relaxed space-y-2">
                        <address class="not-italic">
                            ...
                            <a href="mailto:sosylvie1@gmail.com" class="text-pink-600 hover:underline">📧 sosylvie1@gmail.com</a><br>
                            Permis B – Véhiculée
                        </address>
                        <p>
        ...
        <section aria-labelledby="xp-title">
            <div class="bg-white/60 backdrop-blur-md border border-pink-100 shadow-lg rounded-xl p-6 mt-12">
                <h2 id="xp-title" class="text-2xl font-bold text-gray-800 mb-4 border-b-2 border-pink-200 inline-block pb-1">
                    Expériences professionnelles
                </h2>
                <ul class="space-y-6 text-gray-700 leading-relaxed list-outside list-disc ml-5">
                    <li>
        ...
        <section aria-labelledby="skills-title">
            <div class="bg-white/60 backdrop-blur-md border border-pink-100 shadow-lg rounded-xl p-6 mt-12">
                <h2 id="skills-title" class="text-2xl font-bold text-gray-800 mb-4 border-b-2 border-pink-200 inline-block pb-1">
        ...
        <section aria-labelledby="soft-skills-title">
            <div class="bg-white/60 backdrop-blur-md border border-pink-100 shadow-lg rounded-xl p-6 mt-12">
                <h2 id="soft-skills-title" class="text-2xl font-bold text-gray-800 mb-4 border-b-2 border-pink-200 inline-block pb-1">
        ...
        <section aria-labelledby="formations-title">
            <div class="bg-white/60 backdrop-blur-md border border-pink-100 shadow-lg rounded-xl p-6 mt-12">
                <h2 id="formations-title" class="text-2xl font-bold text-gray-800 mb-4 border-b-2 border-pink-200 inline-block pb-1">
                    Formations
                </h2>
