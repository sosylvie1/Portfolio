...
@section('title', 'Conditions Générales d’Utilisation - Portfolio de Sylvie Seguinaud')

@section('content')
    <div class="bg-pink-50 py-12 sm:py-16" aria-labelledby="cgu-title">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 bg-white shadow-md rounded-2xl p-8 sm:p-12">

            {{-- Titre --}}
            <h1 id="cgu-title" class="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6 text-center">
...
{!! json_encode([
    ...
    '@type' => 'WebPage',
    'name' => 'Conditions Générales d’Utilisation - Portfolio de Sylvie Seguinaud',
