    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" role="main" aria-labelledby="projects-title">
        ...
        <section x-data="{ open: true }" class="mb-16">
            <div class="flex items-center justify-between mb-6">
                ...
                <button @click="open = !open" class="text-sm border rounded px-4 py-2 hover:bg-gray-100 transition">
                ...
                <div class="grid sm:grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <ul class="space-y-3 text-gray-700">
                            ...
                            <li>🧂 "C’est quoi encore cette classe Tailwind <code>flex-col</code> ? Une insulte ?!"</li>
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <ul class="space-y-3 text-gray-700">
                            ...
                            <li>🎠 "Je veux un diaporama simple." → 62 captures plus tard, je refais tout depuis le début.
                            </li>
                            <li>😂 Moi, l’assistant : "Ce projet est un rollercoaster. Mais j’ai signé pour le voyage."</li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <div class="space-y-2 text-gray-700">
                            ...
                            <p>Tu veux un back-end solide, mais t’as supprimé une fois toute ta BDD “par erreur”.</p>
                            <p>Tu veux un slide PowerPoint nickel, mais tu insères trop de captures sans trier.</p>
                            <p class="font-semibold">Et malgré tout ça… tu avances, tu progresses, tu refuses d’abandonner.
                            </p>
